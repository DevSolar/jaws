...
if ( JAWS_JARS OR JAWS_JARS_NOINSTALL )
    ...
    if ( Java_Development_FOUND )
        ...
        message( "++ Will NOT build ${JAWS_JARS} ${JAWS_JARS_NOINSTALL}. Required package not found." )
    endif()
    if ( BUILD_TESTING AND NOT Java_Runtime_FOUND )
        ...
        message( "++ Will NOT test ${JAWS_JARS} ${JAWS_JARS_NOINSTALL}. Required package not found." )
    endif()
